module.exports = {
  Admins: ["727112498209226823", "UserID"], // Admins of the bot, I don't know what this do. -Darren.
  ...
  Lavalink: {
    ...
    host: "lavalink-replit-2.naiml007.repl.co", //- The host name or IP of the lavalink server.
    port: 443, // The port that lavalink is listening to. This must be a number!
    pass: "freeno3", //- The password of the lavalink server.
